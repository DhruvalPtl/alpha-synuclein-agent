...
Experiment: exp_004_laptop_rf_verify_check
...
EXP_ID               = "exp_004_laptop_rf_verify_check"
ARCHITECTURE         = "rf_verify_check"
ARCHITECTURE_FAMILY  = "tree_ensemble"
TIMESTAMP            = "2026-06-24T19:00:51"
HYPERPARAMS: dict = __import__('json').loads('{"n_estimators": 50}')
...
try:
    ...
    if hasattr(model, "predict_proba"):
        try:
            ...
            print(f"[harness] predict_proba failed: {_e}")
